...
export default function Winnerscreen(){
    ...
    return(
        <div className=" w-screen h-screen h-3/4 bg-blue-500 bg-cover opacity-85 backdrop-blur-2xl bg-cover bg-center onecop" style={{ backgroundImage: `url(${copimg})`}}>
        
        <div className=' w-full sm:h-1/4  h-16 flex justify-center items-center align-middle mb-3'>
        <h1 className=' font-serif sm:text-6xl text-lg font-bold text-yellow-300 animate-bounce bg-slate-600' >WINNER : {name}</h1>
        </div>


        <div className=' w-full sm:h-1/4 h-3  flex justify-center items-center opacity-85'>
        <h1 className=' font-serif sm:text-3xl font-bold text-red-600 sm:w-1/2 w-full bg-slate-400' > I have captured the fugitive with your help  </h1>
        </div>
        
        <div className=' w-full h-1/4 flex justify-center items-center opacity-85'>
        <h1 className=' font-serif sm:text-3xl  text-lg font-bold text-black-600 w-full sm:w-1/2 bg-slate-400' >THANK YOU FOR YOUR HELP  </h1>
        </div>


        <div className=' w-full h-1/3 flex justify-center items-center opacity-85'>
        <div  className=" mt-9 ml-6 mr-6 bg-yellow-300 text-red-600 hover:text-green-600 flex justify-center items-center rounded-4xl  w-3/4 h-8 sm:text-2xl opacity-85 hover:font-bold hover:bg-white"
             onClick={handleclick}>
             Lets do that again 
        </div>
        </div>
