...
export default function Winnerscreen(){
  ...
  return (
    <div
      className=" w-screen h-screen  bg-blue-500  opacity-100 backdrop-blur-2xl bg-cover bg-center onecop"
      style={{ backgroundImage: `url(${copimg})` }}
    >
      <div className=" w-full sm:h-1/4  h-16 flex justify-center items-center align-middle mb-3">
        <h1 className=" font-serif sm:text-6xl text-lg font-bold text-yellow-300 animate-bounce bg-slate-600">
          WINNER : {name}
        </h1>
      </div>

      <div className=" w-full sm:h-1/4 h-3  flex justify-center items-center sm:opacity-85 opacity-100">
        <h1 className=" text-2xl font-serif sm:text-3xl font-bold text-red-600 sm:w-1/2 w-full bg-slate-400">
          I have captured the fugitive with your help.
        </h1>
      </div>

      <div className=" w-full h-1/4 flex justify-center items-center opacity-85">
        <h1 className=" font-serif sm:text-3xl  text-lg font-bold text-black-600 w-full sm:w-1/2 bg-slate-400">
      ...
      <div className=" w-full flex justify-center items-center opacity-85">
        <div
          className=" mt-9 ml-6 mr-6 bg-yellow-300 text-red-600 hover:text-green-600 flex justify-center items-center rounded-4xl  w-3/4 h-8 sm:text-2xl opacity-85 hover:font-bold hover:bg-white"
          onClick={handleclick}
        >
          Lets do that again
        </div>
