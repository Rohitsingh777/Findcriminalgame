...
export default function Copplayscreen(){
    ...
    return(
       ...
       <span className=' text-black '> {name} </span> 
        ...
        <h1 className=' font-serif sm:text-3xl  text-lg font-bold text-black-600 w-full sm:w-1/2 mt-2 bg-slate-400' > Can you help me spot where the criminal is from 5 cities </h1>
        </div>
