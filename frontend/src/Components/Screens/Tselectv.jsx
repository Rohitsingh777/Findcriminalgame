...
export default function TSelectvehicle(){
  ...
  return (
    ...
    <label className="  bg-red-400 text-yellow-500 flex items-center justify-center 
        hover:bg-slate-200 animate-pulse animate-bounce font-bold text-shadow-black">SELECT A Vehicle</label>
        ...
        >
          ...
          >
            <span className="text-white text-center p-2">{vehicle}</span>
             ...
             <button
            className=" w-full mt-9 bg-black text-red-600 rounded-lg min-h-8 min-w-8 hover:text-green-600"
            onClick={() => {
                if(vehicleselected){
