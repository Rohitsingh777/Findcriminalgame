...
export default function Cluescreen() {
  ...
  return (
    <div className="sm:h-96 sm:w-3/4 bg-red-400 justify-center items-center flex h-screen w-full">
      <div className=" font-mono bg-cover bg-center sm:h-96 w-full h-screen" style={{backgroundImage : `url(${Criminal})`, backgroundSize: 'cover', }}>
        ...
        Mr Whoever, its me again .Gotta get outta this town. <span className=" text-red-500">{clue}</span>
        </div>
        <div>
          <button
